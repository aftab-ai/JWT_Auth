...
// w-full sm:max-w-5xl m-4 p-4 font-bold text-3xl text-center text-[#10403B] rounded-xl bg-[#B3C1A8]
function Home() {
  return (
    <div className="flex flex-col items-center justify-start h-auto sm:min-h-screen p-2 sm:p-4">
      {/* Title */}
      <h1 className="w-full sm:max-w-5xl m-2 sm:m-4 p-2 sm:p-4 font-bold text-2xl sm:text-3xl text-center text-[#10403B] rounded-xl bg-[#D3D2C7]">
        Full-Stack JWT Authentication System
      </h1>

      {/* Content */}
      <div className="w-full sm:max-w-5xl p-2 sm:p-4 rounded-xl bg-[#D3D2C7]">
        <p className="p-2 sm:p-4 font-bold rounded-2xl text-center text-[#3D503A] bg-[#B3C1A8] ">
        ...
        <div className="m-2 sm:m-4 p-2 sm:p-4">
          <ol className="list-decimal list-outside mx-2 space-y-6 font-bold text-xl text-[#10403B]">
            {/* Project Features */}
            <li>
              Project Features
              {/* Backend */}
              ...
              {/* Frontend */}
              <ol className="list-[upper-roman] list-outside mx-4 mt-3 space-y-3 font-bold text-justify text-lg">
                <p className="w-full mt-2 sm:mt-4 underline text-center">
                  Frontend
                </p>
