function LogoutRoute() {
  return (
    <div className="m-4 text-justify">
      {/* Title */}
      <h1 className="font-bold text-2xl text-[#10403B]">Logout Route</h1>

      {/* List */}
      <div className="mt-2 p-2 text-sm border border-[#B7BDA9] rounded">
        <ul className="list-disc list-outside ml-8">
          <li>Terminates the session and logs the user out from the server.</li>
          <li>
            Access-Token, CSRF-Token and Refresh-Token would be removed from the
            servers.
          </li>
      ...
      <div className="mt-4">
        ...
        <div className="mt-1 p-1 border border-[#B7BDA9] rounded">
          <code className="block leading-relaxed py-1 pl-2 rounded text-sm bg-[#B3C1A8]">
            Endpoint:
            <span className="text-[#127369]"> POST</span> "/api/v1/auth/logout"
          </code>
